import {
  ...
  useFocusGuards,
  usePrevious
} from "./chunk-3244PQYP.js";
import {
  dist_exports as dist_exports4
} from "./chunk-CXJGHDSM.js";
import {
  clamp,
  dist_exports as dist_exports2,
  useDirection
} from "./chunk-JIGQ7GOW.js";
import {
  dist_exports as dist_exports6
} from "./chunk-3VCAVD3Z.js";
import {
  Anchor,
  Arrow,
  Branch,
  ...
  useId,
  useSize
} from "./chunk-WJWOH7EC.js";
import {
  Presence
} from "./chunk-2YVXP7XB.js";
import {
  Primitive,
  Root,
...
var PasswordToggleField = ({
  ...
  const [inputIdState, setInputIdState] = React22.useState(defaultInputId);
  const inputId = inputIdState ?? defaultInputId;
  const syncInputId = React22.useCallback(
  ...
  const focusState = React22.useRef(INITIAL_FOCUS_STATE);
...
var PasswordToggleFieldInput = React22.forwardRef(
  ({
    __scopePasswordToggleField,
...
var PasswordToggleFieldToggle = React22.forwardRef(
  ({
    __scopePasswordToggleField,
    onClick,
    onPointerDown,
    ...
    const [internalAriaLabel, setInternalAriaLabel] = React22.useState(void 0);
...
var PasswordToggleFieldIcon = React22.forwardRef(
  ({
    __scopePasswordToggleField,
    // @ts-expect-error
    children,
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React23.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime23.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React23.isValidElement(newElement) ? React23.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable4(child) {
  return React23.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER4;
}
...
var Popover = (props) => {
  ...
  const [hasCustomAnchor, setHasCustomAnchor] = React24.useState(false);
  const [open, setOpen] = useControllableState({
    prop: openProp,
    defaultProp: defaultOpen ?? false,
    onChange: onOpenChange,
  ...
  return (0, import_jsx_runtime24.jsx)(Root22, { ...popperScope, children: (0, import_jsx_runtime24.jsx)(
    PopoverProvider,
    {
      ...
      hasCustomAnchor,
      onCustomAnchorAdd: React24.useCallback(() => setHasCustomAnchor(true), []),
      onCustomAnchorRemove: React24.useCallback(() => setHasCustomAnchor(false), []),
      modal,
      children
    }
  ) });
...
var PopoverAnchor = React24.forwardRef(
  (props, forwardedRef) => {
...
var PopoverTrigger = React24.forwardRef(
  (props, forwardedRef) => {
...
var PopoverContentModal = React24.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME11, props.__scopePopover);
    const contentRef = React24.useRef(null);
    const composedRefs = useComposedRefs(forwardedRef, contentRef);
    const isRightClickOutsideRef = React24.useRef(false);
    React24.useEffect(() => {
      const content = contentRef.current;
      if (content) return hideOthers(content);
    }, []);
...
var PopoverContentNonModal = React24.forwardRef(
  (props, forwardedRef) => {
    const context = usePopoverContext(CONTENT_NAME11, props.__scopePopover);
...
var PopoverContentImpl = React24.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopePopover,
      trapFocus,
...
var PopoverClose = React24.forwardRef(
  (props, forwardedRef) => {
...
var PopoverArrow = React24.forwardRef(
  (props, forwardedRef) => {
...
var ProgressIndicator = React25.forwardRef(
  (props, forwardedRef) => {
...
var RadioIndicator = React27.forwardRef(
  (props, forwardedRef) => {
...
var RadioBubbleInput = React27.forwardRef(
  ({
    __scopeRadio,
    control,
    checked,
...
var RadioGroup3 = React26.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeRadioGroup,
      name,
...
var RadioGroupItem = React26.forwardRef(
  (props, forwardedRef) => {
...
var RadioGroupIndicator = React26.forwardRef(
  (props, forwardedRef) => {
...
function createSlot5(ownerName) {
  ...
  const Slot22 = React30.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime30.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React30.isValidElement(newElement) ? React30.cloneElement(newElement, void 0, newChildren) : null });
    }
...
function isSlottable5(child) {
  return React30.isValidElement(child) && typeof child.type === "function" && "__radixId" in child.type && child.type.__radixId === SLOTTABLE_IDENTIFIER5;
}
...
var TabsContent = React32.forwardRef(
  (props, forwardedRef) => {
    ...
    const contentId = makeContentId2(context.baseId, value);
    const isSelected = value === context.value;
    const isMountAnimationPreventedRef = React32.useRef(isSelected);
    React32.useEffect(() => {
      const rAF = requestAnimationFrame(() => isMountAnimationPreventedRef.current = false);
      return () => cancelAnimationFrame(rAF);
    }, []);
...
var ToastProvider = (props) => {
  ...
  const [toastCount, setToastCount] = React33.useState(0);
  const isFocusedToastEscapeKeyDownRef = React33.useRef(false);
  const isClosePausedRef = React33.useRef(false);
  if (!label.trim()) {
    console.error(
  ...
  return (0, import_jsx_runtime33.jsx)(Collection8.Provider, { scope: __scopeToast, children: (0, import_jsx_runtime33.jsx)(
    ToastProviderProvider,
    {
      ...
      viewport,
      onViewportChange: setViewport,
      onToastAdd: React33.useCallback(() => setToastCount((prevCount) => prevCount + 1), []),
      onToastRemove: React33.useCallback(() => setToastCount((prevCount) => prevCount - 1), []),
...
var ToastViewport = React33.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
    ...
    const headFocusProxyRef = React33.useRef(null);
    const tailFocusProxyRef = React33.useRef(null);
    ...
    const getSortedTabbableCandidates = React33.useCallback(
      ({ tabbingDirection }) => {
...
var FocusProxy = React33.forwardRef(
  (props, forwardedRef) => {
...
var ToastImpl = React33.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToast,
      type = "foreground",
    ...
    const [node, setNode] = React33.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node2) => setNode(node2));
    const pointerStartRef = React33.useRef(null);
    const swipeDeltaRef = React33.useRef(null);
    const duration = durationProp || context.duration;
    const closeTimerStartTimeRef = React33.useRef(0);
    const closeTimerRemainingTimeRef = React33.useRef(duration);
    ...
    const startTimer = React33.useCallback(
      (duration2) => {
    ...
    const announceTextContent = React33.useMemo(() => {
...
var ToastAnnounce = (props) => {
  ...
  const context = useToastProviderContext(TOAST_NAME, __scopeToast);
  const [renderAnnounceText, setRenderAnnounceText] = React33.useState(false);
  const [isAnnounced, setIsAnnounced] = React33.useState(false);
...
var ToastTitle = React33.forwardRef(
  (props, forwardedRef) => {
...
var ToastDescription = React33.forwardRef(
  (props, forwardedRef) => {
...
var ToastAction = React33.forwardRef(
  (props, forwardedRef) => {
...
var ToastClose = React33.forwardRef(
  (props, forwardedRef) => {
...
var ToastAnnounceExclude = React33.forwardRef((props, forwardedRef) => {
...
var NAME5 = "Toggle";
var Toggle = React34.forwardRef((props, forwardedRef) => {
